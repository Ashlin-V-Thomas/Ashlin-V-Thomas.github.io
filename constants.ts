...
export const ABOUT_TEXT = [
  "I am an Integrated MSc. student at the National Institute of Science Education and Research (NISER) Bhubaneswar, India. Currently, I am pursuing a major degree in physics and a minor degree in mathematics; and have completed seven semesters of the course.",
...
export const INTERESTS = [
  { title: "Theoretical Physics", desc: "A hundred more years in your life without this beautiful subject or one more year with it, I would happily choose the latter." },
  { title: "Mathematics", desc: "The most beautiful language I have ever learned, spoken and written." },
  { title: "Computational studies", desc: "If you find the language of mathematics to be far from the world around you, maybe you should just simulate it!" },
...
export const EDUCATION: Education[] = [
  {
    ...
    period: "2022 - Present",
    description: "I am currently enrolled in the eighth semester of the Integrated MSc. programme at the National Institute of Science Education and Research (NISER), Bhubaneswar, India. I am having a CGPA of 9.76 at the end of seven semesters."
  },
  {
    id: "e2",
    degree: "AISSCE",
